...
- [Parser/parser.y](https://github.com/Gotc2607/Comp-Interpretador-Javascript/blob/main/Parser/parser.y): gramática e construcao dos nos.
- [Parser/ast.h](https://github.com/Gotc2607/Comp-Interpretador-Javascript/blob/main/Parser/ast.h): declaracoes publicas da AST.
- [Parser/ast.c](https://github.com/Gotc2607/Comp-Interpretador-Javascript/blob/main/Parser/ast.c): criacao, avaliacao, liberacao e tabela de simbolos.
- [Lexer/scanner.l](https://github.com/Gotc2607/Comp-Interpretador-Javascript/blob/main/Lexer/scanner.l): analise lexica e preenchimento de valores.
